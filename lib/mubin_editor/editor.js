...
module.exports = class Mubin_Editor
{
    ...
    async load(directory, name)
    {
        ...
        if(!fs.existsSync(`./exported/${document.GK_MAP_NAME}/`))
        {
            fs.mkdirSync(`./exported/${document.GK_MAP_NAME}/`, { recursive: true }); 
        }
        
        fs.writeFileSync(`./exported/${document.GK_MAP_NAME}/scene.txt`, 'Begin Map\nBegin Level\n', { flag: "w+" });
        ...
        let UE_Actor = `Begin Actor Class=/Script/Engine.StaticMeshActor
            ...
            Begin Object Name="StaticMeshComponent0"
               StaticMesh=/Script/Engine.StaticMesh'"/Game/Art/botw/Base_${document.GK_MAP_NAME}.Base_${document.GK_MAP_NAME}"'
        ...
        fs.writeFileSync(`./exported/${document.GK_MAP_NAME}/scene.txt`, UE_Actor, { flag: "a+" });
        ...
        fs.writeFileSync(`./exported/${document.GK_MAP_NAME}/scene.txt`, '   End Level\n        Begin Surface\n        End Surface\n        End Map\n', { flag: "a+" });
