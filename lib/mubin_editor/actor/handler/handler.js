...
module.exports = class Actor_Handler
{
    ...
    async addActor(name, params, type, alreadyIncluded = true)
    {
        ...
        console.info(`create instance: ${name} - ${instance.pos.x},${instance.pos.y},${instance.pos.z} - ${instance.rot.x},${instance.rot.y},${instance.rot.z} - ${instance.scale.x},${instance.scale.y},${instance.scale.z}`);
